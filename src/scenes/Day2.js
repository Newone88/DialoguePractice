class Day2 extends Phaser.Scene {
    ...
    create() {
        ...
        this.color_tutorial = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+600, 'Color_Tutorial').setOrigin(0, 1).setScale(0.70,0.60);
        this.pen_tutorial = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+600, 'PEN_Tutorial').setOrigin(0, 1).setScale(0.70,0.65);
