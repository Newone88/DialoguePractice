class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.banquo = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'banquo').setOrigin(0, 1).setScale(0.3);
        this.fleance = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'fleance').setOrigin(0, 1).setScale(0.6);
